...
Estado actual: **M0–M4 completados** (M2 y M3 fusionaron sus slices originales en unidades funcionales, ver notas al pie), **M5 siguiente** — ver `checkpoints/CHECKPOINT.md`.
