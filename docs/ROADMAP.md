...
Estado actual: **M0–M5 completados** (M2 y M3 fusionaron sus slices originales en unidades funcionales, ver notas al pie), **M6 siguiente** — ver `checkpoints/CHECKPOINT.md`.
