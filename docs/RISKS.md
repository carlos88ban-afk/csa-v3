...
|---|---|---|
| R-006 | `DATABASE_URL` usa la conexión directa de Neon, no la *pooled* | Cerrado 2026-08-04 — `.env` local y las env vars de producción en Vercel usan la connection string con `-pooler` en el host (`ep-lingering-truth-axqm6usi-pooler...`). |
