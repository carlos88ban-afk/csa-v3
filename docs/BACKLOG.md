...
- [ ] VS-067 — Adjuntar archivos o enlaces por celda (`formTableCell.references: optionReferences`, cellType `"referencia"`, HTML real `COG_ManagementOwnership_Selection` enviado por el usuario: columna "Pruebas que lo respaldan" — spec en `docs/engines/form.md`) — implementado 2026-08-18, **pendiente de verificación en producción**
