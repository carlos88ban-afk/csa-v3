...
- [ ] VS-066 — Combinar columnas (colspan) + vista previa de contenido en el chip de celda (`formTableCell.colSpan`, HTML real `COG_DisclosureMedian_Selection` enviado por el usuario: encabezado y fila de compensación del CEO combinan 2 columnas — spec en `docs/engines/form.md`) — implementado 2026-08-18, **pendiente de verificación en producción**
